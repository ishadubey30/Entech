...
class _StateCounselling extends State<StateCounselling> {
  final _coun_types = ['SRMCEM', 'IET', 'BBD', 'GGIT', 'KIET', 'PSIT'];
  final branchtypes = [
    'ComputerScience',
  ...
  var _currentItemSelected1 = 'SRMCEM';
  var _currentItemSelected2 = 'IET';
  var _currentItemSelected3 = 'BBD';
  var _currentItemSelected4 = 'GGIT';
  var _currentItemSelected5 = 'KIET';
  var _currentItemSelected6 = 'PSIT';
